...
(function () {
    ...
    function chunkChineseSegment(seg) {
        ...
        const WORD_DICT = [
            ...
            '粉撲', '化妝刷', '美妝工具', '眉膠', '遮瑕液', '高光液', '腮紅棒', '粉底刷', '唇泥', '唇凍盤', '護唇蜜', '假睫毛', '粉撲套盒', '手指粉撲', '野生眉膏', '染眉膏',

            // 常见修饰/营销词（可持续补充）
            '水光', '潤透', '顯白', '秋冬', '韓系', '裸妝', '氛圍感', '元氣', '清透', '清冷', '低飽和', '素顏', '歐美', '混血感', '日雜',
            '嘟嘟唇', '元氣感', '日常妝', '偽素顏',
            '不暈染', '去死皮', '軟化角質', '跨境美妝', '跨境彩妝',
            '小熊', '奶萌', '獨角獸',
            // 來自當前對話中出現頻率較高的原子詞
            '速描', '優美', '順滑', '速幹', '顯色', '持久', '防水',
            '閃亮', '晶透', '亮澤', '水潤', '保溼', '滋潤', '鏡面', '細閃', '碎閃', '珠光',
            '清透', '立體', '自然', '修飾', '提亮', '臥蠶', '持妝',
            '水絨', '多用霜', '多用', '絲滑', '唇頰',
            '唇部護理', '唇部', '泡泡唇膜', '唇膜', '套盒',
            '碎閃唇蜜', '晶鑽', '氧氣感', '偽素顏',
            '學生', '女團色', '秋冬女', '歐美女', '雙頭', '腮紅棒', '奶油', '膏體', '細膩', '媽生', '多用膏', '系列', '四色', '冷韓系', '膨脹色', '胭脂腮紅', '芝士熊寶', '裸色', '糖葫蘆絨', '熊奶霜', '莎琪諾', '花印紀花愛', '卡泡維妮', '（中文品牌佔位）', '唇泥', '柔霧', '絲絨', '色氣', '卡泡維妮', '便攜', '（中文品牌佔位2）', '硅膠', '粉底刷', '色紙', '輕薄', '底妝服帖', '鏡光', '冰透', '純欲', '白開水', '氣質', '珍珠奶茶', '可愛', '十色', '調色', '唇凍盤', '不易沾杯', '色盤', '護唇蜜', '補水', '打底', '唇色', '潤粉膏', '均勻膚色', '萌趣', '雲感', '粉撲套盒', '植絨', '海綿', '手指粉撲', '大容量', '免膠', '假睫毛', '單簇', '分段', '上鏡', '長絨', '不吃粉', '專用', '野生眉膏', '淺色', '久不暈染', '染眉膏', '波浪', '遮瑕液', '高光液', '不卡紋', '不挑皮', '立體塑形', '定型眉膠', '眉毛雨衣', '透明無色', '啫喱', '根根分明', '野生眉'
        ];
        ...
        function tryPartition(allowLastShort) {
            ...
            function dfs(index) {
                ...
                // 先收集所有合法候选，再按长度从大到小尝试（8 → 7 → 6 → 5 → 4）
                const candidates = [];
